...
`wget https://raw.githubusercontent.com/HardSkript/openvpn-installer/master/openvpn-install.sh --no-check-certificate -O openvpn-install.sh; chmod +x openvpn-install.sh; ./openvpn-install.sh`
